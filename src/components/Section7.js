...
const Section7 = () => {
  return (
    <>
      ...
      <div className="expertise-frame mt">
        <div className="driving-property-inquiries-to-group">
          ...
          <div className="frame-parent5">
            <div className="icon-parent">
              ...
              <div className="unlock-the-potential-of-digita-parent">
                <b className="our-service-offerings">Effective CTAs</b>
                <div className="our-carefully-crafted">
                  {" "}
            ...
            <div className="icon-group">
              ...
              <div className="unlock-the-potential-of-digita-parent">
                <b className="our-service-offerings">
        ...
        <div className="frame-parent7">
          ...
          <div className="icon-parent">
            ...
            <div className="unlock-the-potential-of-digita-parent">
              <b className="our-service-offerings">Mobile-First Success:</b>
              <div className="our-carefully-crafted">
      ...
      <div className="frame-parent8 mt">
        <div className="elevate-real-estate-success-wi-parent">
          <b>Your Peace of Mind</b>
        ...
        <button class="m-buttons1 get-started">Get Started</button>
      </div>
